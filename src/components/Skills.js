...
export default function Skills() {
  ...
  return (
    <div
      id="skills"
      className="min-h-screen w-full overflow-x-hidden max-md:py-15 bg-[var(--primary)] text-white flex flex-col items-center justify-center gap-y-6 sm:gap-y-4 px-20 relative bg-dots"
    >
