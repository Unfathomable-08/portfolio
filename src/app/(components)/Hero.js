  ...
  return (
    <div id="home" className="relative w-full bg-[var(--primary)] h-svh flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        {[
          { name: "React", src: "/skills/react.png", top: "15%", left: "20%", duration: 9 },
          { name: "Node.js", src: "/skills/node.png", top: "30%", left: "60%", duration: 11 },
          { name: "Python", src: "/skills/python.png", top: "70%", left: "25%", duration: 10 },
          { name: "Next.js", src: "/skills/next.png", top: "50%", left: "40%", duration: 8 },
          { name: "Socket.io", src: "/skills/socket.png", top: "15%", left: "75%", duration: 9 },
          { name: "Redis", src: "/skills/redis.png", top: "80%", left: "60%", duration: 12 },
          { name: "Express.js", src: "/skills/express.png", top: "35%", left: "10%", duration: 10 },
          { name: "Tailwind CSS", src: "/skills/tailwind.png", top: "65%", left: "80%", duration: 11 },
        ].map((item, i) => (
          <motion.img
            key={i}
            src={item.src}
