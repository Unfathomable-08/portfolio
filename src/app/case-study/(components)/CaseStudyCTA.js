export default function CaseStudyCTA() {
    return (
        <section className="bg-[var(--primary)] px-2! pt-6! sm:px-8! md:px-20!">
            <div className="relative mx-auto max-w-[1440px] overflow-hidden rounded-[0.6rem] sm:rounded-[2rem] border border-white/10 bg-[#0b0d0e] px-5! py-8! sm:px-8! sm:py-12! md:px-12! md:py-16! lg:px-16!">
                ...
                <div className="relative grid items-end gap-6 sm:gap-10 lg:grid-cols-[1fr_auto]">
                    <div>
                        <p className="mb-3! sm:mb-5! text-xs sm:text-sm text-neutral-300">
                            Have something in mind?
                        </p>
                        <h2 className="max-w-4xl text-2xl font-bold leading-[1.1] tracking-[-0.035em] text-white xs:text-3xl sm:text-4xl md:text-5xl lg:text-7xl">
                            Let’s turn your idea into something people want to use.
                        </h2>
                        <p className="mt-4! sm:mt-6! max-w-xl text-xs sm:text-sm leading-6 sm:leading-7 text-neutral-400">
