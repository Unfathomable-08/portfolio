        ...
        <>
            <section ref={ref} id="about" className="min-h-screen bg-primary text-white grid grid-cols-1 md:grid-cols-2 items-center justify-items-center">
                ...
                <div className="grid grid-cols-3 gap-20 items-center md:order-1">
                    <div>
                        <div className="relative h-[70px] w-28 p-[2px] rounded bg-gradient-to-tr from-cyan-400 via-blue-500 to-purple-600 my-6 glow animate__animated wait-fadeIn-about animate__slower html">
                        ...
                        <div className="relative h-[70px] w-28 p-[2px] rounded bg-gradient-to-tr from-cyan-400 via-blue-500 to-purple-600 my-6 glow animate__animated wait-fadeIn-about animate__slower css">
                        ...
                        <div className="relative h-[70px] w-28 p-[2px] rounded bg-gradient-to-tr from-cyan-400 via-blue-500 to-purple-600 my-6 glow animate__animated wait-fadeIn-about animate__slower js">
                        ...
                        <div className="relative h-[70px] w-28 p-[2px] rounded bg-gradient-to-tr from-cyan-400 via-blue-500 to-purple-600 my-6 glow animate__animated wait-fadeIn-about animate__slower bootstrap">
                    ...
                    <div>
                        <div className="relative h-[70px] w-28 p-[2px] rounded bg-gradient-to-tr from-cyan-400 via-blue-500 to-purple-600  my-6 glow animate__animated wait-fadeIn-about animate__slower tailwind">
                        ...
                        <div className="relative h-[70px] w-28 p-[2px] rounded bg-gradient-to-tr from-cyan-400 via-blue-500 to-purple-600 my-6 glow animate__animated wait-fadeIn-about animate__slower react">
                        ...
                        <div className="relative h-[70px] w-28 p-[2px] rounded bg-gradient-to-tr from-cyan-400 via-blue-500 to-purple-600 my-6 glow animate__animated wait-fadeIn-about animate__slower git">
                        ...
                        <div className="relative h-[70px] w-28 p-[2px] rounded bg-gradient-to-tr from-cyan-400 via-blue-500 to-purple-600 my-6 glow animate__animated wait-fadeIn-about animate__slower express">
                        ...
                        <div className="relative h-[70px] w-28 p-[2px] rounded bg-gradient-to-tr from-cyan-400 via-blue-500 to-purple-600 my-6 glow animate__animated wait-fadeIn-about animate__slower wordpress">
                    ...
                    <div>
                        <div className="relative h-[70px] w-28 p-[2px] rounded bg-gradient-to-tr from-cyan-400 via-blue-500 to-purple-600  my-6 glow animate__animated wait-fadeIn-about animate__slower node">
                        ...
                        <div className="relative h-[70px] w-28 p-[2px] rounded bg-gradient-to-tr from-cyan-400 via-blue-500 to-purple-600 my-6 glow animate__animated wait-fadeIn-about animate__slower php">
                        ...
                        <div className="relative h-[70px] w-28 p-[2px] rounded bg-gradient-to-tr from-cyan-400 via-blue-500 to-purple-600 my-6 glow animate__animated wait-fadeIn-about animate__slower mongodb">
                        ...
                        <div className="relative h-[70px] w-28 p-[2px] rounded bg-gradient-to-tr from-cyan-400 via-blue-500 to-purple-600 my-6 glow animate__animated wait-fadeIn-about animate__slower sql">
