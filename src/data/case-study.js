...
export const caseStudies = {
    ...
    emberoak: {
        ...
        about: {
            text: [
                "_Ember_ _Oak_ is a restaurant management demo created to explore how a modern dining business could manage its public website and operational tasks from one connected system.",
                "Customers can browse the menu, place dine-in or delivery orders, pay through Stripe, and reserve a table through a dedicated booking experience.",
                "Behind the scenes, admin pages bring reservations, incoming orders, and menu products together. The project is primarily a demonstration rather than a production restaurant platform, with particular focus on advanced UI, animation, and clear management workflows."
            ],
